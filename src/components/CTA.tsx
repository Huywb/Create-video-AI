            ...
            <div className="container mx-auto max-w-3xl">
                <div className="rounded-3xl bg-linear-to-b from-violet-900/20 to-violet-900/5 border border-violet-500/20 p-12 md:p-16 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        >
                            Ready to transform your product videos with AI?
                        </motion.h2>
                        ...
                        >
                            Join thousands of creators and businesses using our platform to create stunning videos in seconds. Sign up now and unleash your creativity with the power of AI.
                        </motion.p>
                        <motion.div
                            initial={{ y: 60, opacity: 0 }}
                            whileInView={{ y: 0, opacity: 1 }}
