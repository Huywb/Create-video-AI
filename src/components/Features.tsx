        ...
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    ...
                    description="Our platform is designed to empower creators with the tools they need to bring their visions to life. From intuitive interfaces to powerful AI capabilities, we provide everything you need to create stunning videos in seconds."
                />
