                ...
                <div className="flex gap-20 max-sm:flex-col items-start justify-between">
                    ...
                    <div className="w-full">
                        ...
                        <div className="mb-4 text-gray-300">
                            ...
                            <input type="text" id="productName" value={productName} onChange={(e)=>setProductName(e.target.value)} placeholder="Enter name of product" required 
                                className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none transition-all"
                            />
                        </div>
                        ...
                        <div className="mb-4 text-gray-300">
                            ...
                            <textarea id="productDescription" rows={4} value={productDescription} onChange={(e)=>setProductDescription(e.target.value)} placeholder="Enter the description of product"
                        ...
                        <div className="mb-4 text-gray-300">
                            ...
                            <div className="flex gap-3">
                                <RectangleVertical onClick={()=>setAspectRatio('9:16')}
                                ...
                                <RectangleHorizontal onClick={()=>setAspectRatio('16:9')}
                                    className={`p-2.5 size-13 bg-white/6 rounded transition-all ring-2 ring-transparent cursor-pointer
                        ...
                        <div className="mb-4 text-gray-300">
                            ...
                            <textarea id="userPrompt" rows={4} value={userPrompt} onChange={(e)=>setUserPrompt(e.target.value)} placeholder="Enter your prompt"
                                className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all"    
                            ></textarea>
                        </div>
                ...
                <div className="flex justify-center mt-10">
                    <PrimaryButton disabled={isGenerating} className="px-10 py-3 rounded-md disabled:opacity-70 disabled:cursor-not-allowed">
                        {isGenerating ? 
                            (
                                <>
                                <Loader2Icon className="size-5 animate-spin"></Loader2Icon>Generating...
                                </>
                            ) : 
                            (
                                <>
                                <Wand2Icon className="size-5"></Wand2Icon> Generate Image
                                </>
                            )}
                    </PrimaryButton>
                </div>
